...
AirPlay Receiver is a settings-driven feature for System. Allow your Mac to act as a screen/speaker for your iPhone. The value here is persistence: you change the system once, and the new behavior stays available in later sessions until you change it back.
...
2. Navigate to `System Settings > General > AirDrop`, or use Settings search to jump there faster.
3. Change the option deliberately and note the original value first if you might want to revert it later.
4. Check that the behavior now matches the hack: Allow your Mac to act as a screen/speaker for your iPhone.
