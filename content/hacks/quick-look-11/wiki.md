...
Quick Look is a Finder keyboard-led action for Finder. Select any file in Finder and press Spacebar to instantly preview it without opening the app The value here is speed inside an already-open file workflow: picking the right item, triggering the command, and moving on without navigating extra menus.

## Reference

`Select any file in Finder and press Spacebar to instantly preview it without opening the app`
...
3. Use the interaction described by the hack: Select any file in Finder and press Spacebar to instantly preview it without opening the app.
4. Confirm the result: Select any file in Finder and press Spacebar to instantly preview it without opening the app
